...
from label import *
from main import *
from formulaire_reservation import *
from init import *
from prise_de_commande import *
from projet_final import *
...
AddCustomerTopButton = TableMaster_ButtonOnTop(main, "user.png", lambda: client())
OrderTopButton = TableMaster_ButtonOnTop(main, "order.png", lambda: prise_de_commande_line())
ModifOrderTopButton = TableMaster_ButtonOnTop(main, "modify.png", lambda: modif_order())
ShowReservationTopButton = TableMaster_ButtonOnTop(main, "book2.png", lambda: mainLine())
FormBookingTopButton = TableMaster_ButtonOnTop(main, "book.png", lambda: formulaire_reservation_line())
